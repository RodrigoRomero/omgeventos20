...
<table width="600" cellpadding="0" cellspacing="0" style="<?php echo $table ?>">
    ...
    <tr>
        ...
        <td colspan="3">
           ...
           Este email confirma que el pago realizado para el evento <?php echo $evento->nombre ?> a llevarse a cabo el día <?php echo $fecha_inicio_array[2] ?> de <?php echo strtoupper(getMes($fecha_inicio_array[1])) ?>. fue aprobado. Usted adquirió <?php echo $order_info->quantity ?> Entrada(s).
