...
<table width="600" cellpadding="0" cellspacing="0" style="<?php echo $table ?>">
    <tr>
        <td colspan="3">
            ...
            Su pago ha sido acreditado. Le agradecemos la donación que ha realizado a BisBlick Compromiso Social a través del bono contribución.<br />
            No olvide llevar el código de barras, impreso o digital
        </td>
    </tr>
    <tr>
        <td colspan="3">
