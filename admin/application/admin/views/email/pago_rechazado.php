...
<table width="600" cellpadding="0" cellspacing="0" style="<?php echo $table ?>">
    ...
    <tr>
        ...
        <td colspan="3">
            ...
            El pago realizado para participar del evento <?php echo $evento->nombre ?> a llevarse a cabo el día <?php echo $fecha_inicio_array[2] ?> de <?php echo strtoupper(getMes($fecha_inicio_array[1])) ?> fue rechazado. Solicitamos intente realizar la compra nuevamente con una nueva tarjeta de crédito.<br/>
Muchas gracias.<br/>
