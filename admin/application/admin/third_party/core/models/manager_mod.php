...
class manager_mod extends RR_Model {
    var $atributo       = 'managers';
    var $table          = 'managers';
    var $module         = 'manager';
    var $module_title   = "Managers";    
    var $id;
    ...
    public function listado(){
        ...
        $datagrid["columns"][] = array("title" => "Código", "field" => "abr", 'sort'=>'abr');                         
        ...
        if(isset($_POST['search']) && !empty($_POST['search'])) {
            $like_arr = array('nombre', 'apellido', 'abr');            
