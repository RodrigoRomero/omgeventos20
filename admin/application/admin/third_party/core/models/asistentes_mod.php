...
class Asistentes_mod extends RR_Model {
    var $atributo       = 'asistentes';
    var $table          = 'asistentes';
    var $module         = 'asistentes';
    var $module_title   = "Asistentes";
    ...
    public function listado(){
        ...
        $datagrid["columns"][] = array("title" => "User", "field" => "user_name", 'sort'=>'user_name');
        ...
        $action_links['new'] =  array('action' => set_url(array('a'=>'newa', 'iu'=>'new')), 'title' => 'Nuevo Asistente');
