...
class acreditados_mod extends RR_Model {
    ...
    public function exporta(){
        ...
        $columns[] = array("title" => "Cantidad de Empleados");
        $columns[] = array("title" => "Tipo Asistente");
        ...
        $i = 4;               
            ...
            $this->phpexcel->getActiveSheet()->setCellValue("R".$i, $extras->cantidad_empleados);
            ...
            $this->phpexcel->getActiveSheet()->setCellValue("S".$i, $extras->tipo_asistente);
          ...
          #  $this->phpexcel->getActiveSheet()->getColumnDimension("T")->setAutoSize(true);
            ...
            $this->phpexcel->getActiveSheet()->setCellValue("T".$i, $row->status);
            $this->phpexcel->getActiveSheet()->getStyle("T".$i)->getAlignment()->setWrapText(true);
            $this->phpexcel->getActiveSheet()->getColumnDimension("T")->setAutoSize(true);
            ...
            $this->phpexcel->getActiveSheet()->setCellValue("V".$i, $row->acreditado);
