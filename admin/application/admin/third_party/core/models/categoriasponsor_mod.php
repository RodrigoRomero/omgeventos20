...
class categoriasponsor_mod extends RR_Model {
    var $atributo       = 'categoriasponsor';
    var $table          = 'categoriaSponsors';
    var $module         = 'categoriasponsor';
    var $module_title   = "Categorías Sponsors";    
    var $id;
