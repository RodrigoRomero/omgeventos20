...
<div class="col-md-3 col-xs-6 price-table <?php echo strtolower($nombre) ?> <?php echo ($hoy < $timelimit || ($precio_regular>0) && !$agotadas) ? 'pointer jPrice' : ''; ?>" data-price="<?php echo $data_price ?>">
    <?php if($hoy > $timelimit && ($precio_regular==0) || $agotadas) { ?>
    ...
    <?php } ?>
        ...
        <h3><?php echo $nombre ?>
            ...
            <?php if($hoy < $timelimit || ($precio_regular==0)) { ?>
...
<?php if(!empty($precio_oferta) && ($hoy < $timelimit)) { ?>
