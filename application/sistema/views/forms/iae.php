...
echo form_hidden('ticket_sku','iae_0-2');
echo form_hidden('ticket_ammount',0);
echo form_hidden('ticket_name','Miembro Antiguo IAE');
...
function resetValues(){
    $('input[name=ticket_sku').val('iae_0-2');
    $('input[name=ticket_ammount').val(0);
    $('input[name=ticket_name').val('Miembro Antiguo IAE');
}
</script>