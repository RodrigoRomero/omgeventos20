...
<table width="650" cellpadding="0" cellspacing="0" style="<?php echo $table ?>">
    ...
    <tr>
        <td  style="text-align: center; padding: 10px" colspan="3">
            <p style="color: #444242; font-size: 15px; text-align: center">Hola <?php echo $user->nombre.' '. $user->apellido ?>: <br/> Te escribimos para recordarte que ya estas registrado a <b><?php echo $evento->nombre ?></b>.  <br/> Nos vemos!</p>
        </td>
    </tr>
    ...
    <tr>
        <td style="padding: 10px 0; border-top: 2px solid #ebebeb; border-bottom: 2px solid #ebebeb; text-align:center;" colspan="3">
            <p style="<?php echo $p ?>">No olvides traer el código de barras impreso o digital</p>
        </td>
    </tr>
