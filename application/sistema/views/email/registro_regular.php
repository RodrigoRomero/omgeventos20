...
<table width="600" cellpadding="0" cellspacing="0" style="<?php echo $table ?>">
    <tr>
        <td colspan="3">
           ...
           Agradecemos su interés en el evento.<br/>
           Usted está pre registrado en el evento "BGH Tech Partner Inspire Forum", a realizarse el jueves 2 de Junio.  <b>En breve recibirá un correo con la confirmación de su registro.</b><br/>

		   Evento exclusivo para C-Levels, Directores y Gerentes de TI y Areas de Negocio. Cupos limitados.<br/>
		   Saludos, <br/>


<?php echo $evento->nombre ?>.</p>
        </td>
    </tr>
    <!--<tr>
        <td colspan="3">
