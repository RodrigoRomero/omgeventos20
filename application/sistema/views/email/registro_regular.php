...
<table width="650" cellpadding="0" cellspacing="0" style="<?php echo $table ?>">
    ...
    <tr>
        <td style="padding: 10px 0; border-top: 2px solid #ebebeb; border-bottom: 2px solid #ebebeb; text-align:center;" colspan="3">
            <p style="<?php echo $p ?>">Gracias por registrarte a <?php echo $evento->nombre ?>.<br />No olvides traer el código de barras impreso o digital</p>
        </td>
    </tr>
    <tr>
        <td colspan="3">
            <?php echo up_asset('barcodes/'.$user_info->barcode.'.png', array('style'=>'display: block; margin: 40px auto;')) ?>
        </td>
    </tr>
