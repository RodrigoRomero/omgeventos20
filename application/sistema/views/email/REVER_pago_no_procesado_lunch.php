...
<table width="600" cellpadding="0" cellspacing="0" style="<?php echo $table ?>">
    <tr>
        <td colspan="3">
            ...
            Usted se ha pre-inscripto para participar del <?php echo $evento->nombre ?>.<br/>
            Confirmando su  registro mediante el pago, podemos confirmar registro y asegurarle el lugar.<br/>
            <a href="<?php echo lang_url('evento/almuerzo/'.$user_info->salt) ?>" style="<?php echo $btn ?>">Participar</a><br/>
