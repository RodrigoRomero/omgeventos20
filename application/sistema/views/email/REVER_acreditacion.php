...
<table width="600" cellpadding="0" cellspacing="0" style="<?php echo $table ?>">
    <tr>
        <td colspan="3">
            <p style="<?php echo $p ?>">Sr. <?php echo $nombre.' '.$apellido ?><br />
            Su inscripción al evento <?php echo $evento->nombre ?>.<br />
            Los lugares dentro del auditorio son limitados por lo que rogamos ser puntuales.<br />
            Es importante contar con el siguiente código de barras, ya sea en su celular o impreso, para acceder rápidamente.<br /> 
    ...
    <tr>
        <td colspan="3">
            <?php echo up_asset('barcodes/'.$barcode.'.png', array('style'=>'display: block; margin: 0 auto;')) ?>
        </td>
    </tr>
    <tr>
    ...
    <tr>
        <td><?php echo image_asset('site/evento_mail.png', '','') ?></td>
    </tr>
</table>
