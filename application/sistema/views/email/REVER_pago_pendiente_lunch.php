...
<table width="600" cellpadding="0" cellspacing="0" style="<?php echo $table ?>">
    <tr>
        <td colspan="3">
            ...
            El pago realizado se encuentra pendiente de revisión por Mercado Pago. Le solicitamos por favor ponerse en contacto con:
Jessica Meccia (<a href="mailto:soporte@amdia.org.ar">soporte@amdia.org.ar</a>)<br/>
Le agradecemos mucho su colaboración y le pedimos disculpas por las molestias que podría causarle.
Saludos</p>
        </td>
    </tr>
