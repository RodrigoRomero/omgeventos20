...
<table width="600" cellpadding="0" cellspacing="0" style="<?php echo $table ?>">
    <tr>
        <td colspan="3">
            ...
            Lamentablemente Mercado Pago ha rechazado su tarjeta por motivos que desconocemos. Le solicitamos por favor comunicarse con: Jessica Meccia (<a href="mailto:soporte@amdia.org.ar">soporte@amdia.org.ar</a>), si desea puede intentar con una nueva tarjeta  <a href="<?php echo lang_url('payments/latecheckout/'.$user_info->salt) ?>" style="<?php echo $btn ?>"></a>  o bien coordinar con nosotros otra forma de pago.
            Le agradecemos mucho su colaboración y le pedimos disculpas por las molestias causadas.<br />
            Saludos,</p>
        </td>
    </tr>
