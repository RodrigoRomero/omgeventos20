	...
	<nav class="navbar navbar-inverse" role="navigation"><!-- add "wihite" class for white nav bar -->
		<div class="container">
			...
			<div class="navbar-header">
				...
				<a href="https://twitter.com/BGHTechPartner" target="_blank" class="social fa fa-twitter" ></a>
				<a href="https://www.linkedin.com/company/bgh-tech-partner" target="_blank" class="social fa fa-linkedin"></a>
				<a href="https://www.youtube.com/channel/UCFR_05_V8WLd80a9Hy2p4lA?spfreload=5" target="_blank" class="social fa fa-youtube-play"></a>
			...
			<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
				...
				<ul class="nav navbar-nav navbar-right">
                    ...
                    <li><a href="#bisblick" class="scrollTo">Descargas</a></li>
					<li><a href="#galeria" class="scrollTo">Galería</a></li>
					<li><a href="#registrese" class="scrollTo">Regístrese</a></li>
