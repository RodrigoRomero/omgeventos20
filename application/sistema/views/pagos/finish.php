        <?php        
        $status_pago = '';
        switch($order_details->pago_status){
            case 1:
        ...
        <section id="finish">
            <div class="container">
                ...
                <div>
                    <h2 class="sectionTitle">Gracias <?php echo $order_details->nombre.' '.$order_details->apellido ?>. Su orden ha sido recibida!</h2>
                    <div id="orderDetail">
                        <ul>
                            <li> <i class="fa fa-arrow-circle-o-right"></i> Numero de orden: <span><?php echo $order_details->id ?></span></li>
                            <li> <i class="fa fa-arrow-circle-o-right"></i> Fecha: <span><?php echo SpanishDate($order_details->fa) ?></span></li>
