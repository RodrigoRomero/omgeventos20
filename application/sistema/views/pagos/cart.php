...
<li class="tableHead row">
    <div class="col-md-12">
        <div class="row">
            ...
            <div class="hidden-xs col-md-3"> <div class="hidden-md hidden-lg">Total</div> <div class="hidden-xs hidden-sm">Total</div> </div>
        </div>
    </div>
</li> <!-- #tableHeader -->
<?php
 ...
 <li class="item <?php echo $discount ?> row">
    <div class="col-md-12">
        <div class="row">
            ...
            <div class="precioUnidad col-xs-3 col-md-1"> <?php echo $row['subtotal'] ?> </div>
