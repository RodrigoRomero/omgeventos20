...
class Residencia_mod extends RR_Model {
    var $atributo = 'residencias';
    var $table    = 'residencias';
    ...
    public function set_iu(){
        $action = set_url(array('residencias'=>'do_iu'));
    ...
    public function do_iu(){
         ...
         if($this->form_validation->run('Atributos')==FALSE){
            ...
            if($query){
                ...
                $data    = array('success' =>$success,'responseType'=>$responseType, 'value'=>lang_url('residencias/listado'));
            }
